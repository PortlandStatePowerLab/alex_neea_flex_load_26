...
def plot_data(baseline_file, controlled_file, title, photo_file, ax):
    ...
    ax.plot(df_base['Time'][-NUM_POINTS:],
            df_base['baseline'][-NUM_POINTS:],
            label='baseline',
            color='blue')
    
    ax.plot(df_con['Time'][-NUM_POINTS:],
            df_con['controlled'][-NUM_POINTS:],
            label='controlled',
            color='orange',
            linestyle='--')
    ...
    ax2.plot(df_reg_sig['Time'][-NUM_POINTS:],
            df_reg_sig['signal'][-NUM_POINTS:],
